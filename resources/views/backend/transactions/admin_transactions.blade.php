<?php /* C:\xampp\htdocs\claims\resources\views/backend/transactions/admin_transactions.blade.php */ ?>
...
<div style="color:blue;"  class="card">
    <div  class="card-body">
        ...
        <!-- -->
        <div class="row">
            <form action="{{ route('admin.transactions') }}" class="form-inline offset-2">
                <h6>From</h6>
                ...
                <a href="<?php echo e(route('admin.transactions')); ?>" class="btn btn-info btn-sm float-right"><i><b>Refresh</b></i></a>
            </form>
        </div>
        <div class="clearfix"></div>
        <div  class="row">
