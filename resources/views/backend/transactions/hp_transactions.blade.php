<?php /* C:\xampp\htdocs\claims\resources\views/backend/transactions/hp_transactions.blade.php */ ?>
<?php $__env->startSection('title', 'HP_Transactions'); ?>
...
<div style="color:blue;"  class="card">
    <div  class="card-body">
        <h4 class="card-title float-left"><b><i>Transactions</i></b></h4>
    
        <div class="clearfix"></div>
        <!-- -->
        <div class="row">
            <form action="{{ route('hp.transactions') }}" class="form-inline offset-2">
                <h6>From</h6>
                ...
                <a href="<?php echo e(route('hp.transactions')); ?>" class="btn btn-info btn-sm float-right"><i><b>Refresh</b></i></a>
            </form>
        </div>
        <div class="clearfix"></div>
        <div  class="row">
                ...
                <div  class="table-responsive">
                    ...
                    <table  id="order-listing" class="table">
                        ...
                        <tr>
                            ...
                            <th><b><i>HIA</i></b></th>
                            <th><b><i>HP_Type</i></b></th>
                            <th><b><i>HP_Name</i></b></th>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($transaction->company->name); ?></td>
                            <td><?php echo e($transaction->claim->provider->type); ?></td>
                            <td><?php echo e($transaction->claim->provider->name); ?></td>
                            <td style="color:red;"><?php echo e($transaction->service->cost); ?> EGP</td>
                            <td><?php echo e($transaction->created_at); ?></td>
                            <td>
                                <?php if($transaction->payment_status == 'done'): ?>
                                <label class='badge badge-success'><?php echo e($transaction->payment_status); ?></label>
                                <?php elseif($transaction->payment_status == 'rejected'): ?>
                                <label class='badge badge-danger'><?php echo e($order->status->getTrans()->title); ?></label>
                                <?php else: ?>
                                <label class='badge badge-info'><?php echo e($transaction->payment_status); ?></label>
                                <?php endif; ?>
                            </td>
                        </tr>
