<?php /* C:\xampp\htdocs\claims\resources\views/backend/services/index.blade.php */ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-body">
            <h4 class="card-title float-left"><b><i>Services</i></b></h4>
            <a href="<?php echo e(route('services.create')); ?>" class="btn btn-info btn-sm float-right"><i class="mdi mdi-note-plus"></i><i><b> Add New</b></i></a>
            
            <div class="clearfix"></div>
            <!-- -->
        <div class="row">
            <form action="<?php echo e(route('services.index')); ?>" class="form-inline offset-2">
                <h6>From</h6>
                ...
                <a href="<?php echo e(route('services.index')); ?>" class="btn btn-info btn-sm float-right"><i><b>Refresh</b></i></a>
            </form>
        </div>
            <div class="clearfix"></div>
            <div class="row">
                        ...
                        <table id="order-listing" class="table">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <td><?php echo e($service->id); ?></td>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('services.destroy', $service->id)); ?>" method="post" class="">
                                        ...
                                        <br>
                                        <a href=' <?php echo e(route('services.edit', $service->id)); ?>' class="btn btn-outline-primary"> <?php echo e(trans('actions.edit')); ?></a>
                                    </td>
                                </tr>
