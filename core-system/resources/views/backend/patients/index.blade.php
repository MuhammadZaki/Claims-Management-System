<?php /* C:\xampp\htdocs\claims\resources\views/backend/patients/index.blade.php */ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-body">
            <h4 class="card-title float-left"><b><i>Patients</i></b></h4>
            <a href="<?php echo e(route('patients.create')); ?>" class="btn btn-info btn-sm float-right"><i class="mdi mdi-note-plus"></i><i><b> Add New</b></i></a>
            <div class="clearfix"></div>
            <!-- -->
        <div class="row">
            <form action="<?php echo e(route('patients.index')); ?>" class="form-inline offset-2">
                <h6>From</h6>
                ...
                <a href="<?php echo e(route('patients.index')); ?>" class="btn btn-info btn-sm float-right"><i><b>Refresh</b></i></a>
            </form>
        </div>
            <div class="clearfix"></div>
            <div class="row">
                        ...
                        <table id="order-listing" class="table">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <td><?php echo e($patient->id); ?></td>
                                    <td><?php echo e($patient->national_id); ?></td>
                                    <td><?php echo e($patient->name); ?></td>
                                    <td><?php echo e($patient->phone); ?></td>
                                    <td><?php echo e($patient->plan->name); ?></td>
                                    
                                    <td style="color:red;"><?php echo e($patient->credit); ?></td>
                                    <td style="color:red;"><?php echo e($patient->created_at); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('patients.destroy', $patient->id)); ?>" method="post" class="">
                                        ...
                                        <br>
                                        <a href=' <?php echo e(route('patients.edit', $patient->id)); ?>' class="btn btn-outline-primary"> <?php echo e(trans('actions.edit')); ?></a>
                                    </td>
                                </tr>
