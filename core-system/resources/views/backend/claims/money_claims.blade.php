<?php /* C:\xampp\htdocs\claims\resources\views/backend/claims/money_claims.blade.php */ ?>
<?php $__env->startSection('title', 'ClaimsHI'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="color:blue;"  class="card">
        <div class="card-body">
            <h4 class="card-title float-left"><b><i>Claims For Money</i></b></h4>
            <div class="clearfix"></div>
            <!-- -->
        <div class="row">
            <form action="<?php echo e(route('admin.claims.money')); ?>" class="form-inline offset-2">
                <h6>From</h6>
                ...
                <a href="<?php echo e(route('admin.claims.money')); ?>" class="btn btn-info btn-sm float-right"><i><b>Refresh</b></i></a>
            </form>
        </div>
            <div class="clearfix"></div>
            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($claim->status == 'pending'): ?>
                                            <a href=' <?php echo e(route('admin.confirm.payment', $claim->id)); ?>'
                                              class="btn btn-outline-primary" style="color:#191970;"><b><i>Confirm Payment</i></b> </a>
                                        <?php else: ?>
                                            No Action
                                        <?php endif; ?>
                                    </td>
